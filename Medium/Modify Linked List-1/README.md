<h2><a href="https://practice.geeksforgeeks.org/problems/modify-linked-list-1-0546/1?page=1&difficulty[]=1&sortBy=latest">Modify Linked List-1</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a singly linked list containing&nbsp;<strong>N</strong>&nbsp;nodes. Modify the Linked list as follows:</span></p>
